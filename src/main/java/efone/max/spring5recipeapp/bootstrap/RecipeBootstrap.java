package efone.max.spring5recipeapp.bootstrap;

import efone.max.spring5recipeapp.domain.Category;
...
import efone.max.spring5recipeapp.repositories.CategoryRepository;
